UpdateNewsDialog.res
{
	...
	layout
	{
		...
		place { control="frame_minimize,frame_maximize,frame_close" align=right spacing=7 margin-right=12 y=12 }
		...
		place { control="CloseButton,BgRect" region="hidden" width=0 height=0 }
	}
}
