...
IF %MENUCHOICE%==13 SET CHOSEN_COLORTHEME=oled
IF %MENUCHOICE%==14 SET CHOSEN_COLORTHEME=one-pro
IF %MENUCHOICE%==15 SET CHOSEN_COLORTHEME=pop
IF %MENUCHOICE%==16 SET CHOSEN_COLORTHEME=rose-pine
IF %MENUCHOICE%==17 SET CHOSEN_COLORTHEME=tokyo-night
IF %MENUCHOICE%==18 SET CHOSEN_COLORTHEME=tomorrow-night
IF %MENUCHOICE%==19 SET CHOSEN_COLORTHEME=vapor
IF %MENUCHOICE%==20 SET CHOSEN_COLORTHEME=vgui2
IF %MENUCHOICE%==21 SET CHOSEN_COLORTHEME=yaru
ECHO.
