...
:: --- Install ---
:INSTALL_SECTION
install.py -fi -c %CHOSEN_COLORTHEME% %CHOSEN_NO_ROUNDED_CORNERS% %CHOSEN_HIDE_WHATS_NEW% %CHOSEN_SIDEBAR_HOVER_ONLY% %CHOSEN_LOGIN_QR% %CHOSEN_HIDE_BIG_PICTURE_BUTTON% %CHOSEN_HIDE_PAGE_URL% %WINDOW_CONTROLS%
GOTO END_SECTION
